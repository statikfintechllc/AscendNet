...
@router.post("/request")
async def request_compute_job(job_request: ComputeJobRequest, user=Depends(get_current_user)):
...
@router.post("/bid")
async def submit_compute_bid(bid: ComputeBid, user=Depends(get_current_user)):
